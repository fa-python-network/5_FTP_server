...
create <filename> <text> - создать файл, записывать текст в файл, если он передан после имени файла
remove <filename> - удалить файл
rename <oldfilename> <newfilename> - переименовать файл
copy_to_server <filename1> <filename2> - скопировать файл с клиента на сервер
copy_from_server <filename1> <filename2> - скопировать файл с сервера на клиент
exit - выход
'''
