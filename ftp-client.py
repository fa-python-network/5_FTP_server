...
'''
'ls' - показать содержимое текущей(рабочей) директории
'mkdir' - создать папку
'rmdir' - удалить папку
'rm' - удалить файл
'mv' - переименовать файл
'cat' - показать содержимое файла
'pull file1 file2' - обновить файл file2 на локальной машине файлом file1 на сервере (аналогия с гитом) 
'push file1 file2' - pull наоборот
'exit' - выход
'''
